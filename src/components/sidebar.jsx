  ...
  return (
    <>
      <ShadcnSidebar collapsible="icon">
        <SidebarHeader className="flex h-16 items-center border-b px-4 group-has-data-[collapsible=icon]/sidebar-wrapper:h-12 group-has-data-[collapsible=icon]/sidebar-wrapper:px-2">
